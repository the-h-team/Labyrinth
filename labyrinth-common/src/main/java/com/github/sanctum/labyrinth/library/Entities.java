...
public final class Entities {
	...
	public static final Spawner<Item> DROPPED_ITEM = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "ITEM" : "DR0PPED_ITEM"));
	...
	public static final Spawner<EnderCrystal> ENDER_CRYSTAL = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "END_CRYSTAL" : "ENDER_CRYSTAL"));
	...
	public static final Spawner<Firework> FIREWORK = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "FIREWORK_ROCKET" : "FIREWORK"));
	public static final Spawner<FishHook> FISHING_HOOK = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "FISHING_BOBBER" : "FISHING_HOOK"));
	...
	public static final Spawner<LeashHitch> LEASH_HITCH = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "LEASH_KNOT" : "LEASH_HITCH"));
	public static final Spawner<LightningStrike> LIGHTNING = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "LIGHTNING_BOLT" : "LIGHTNING"));
	...
	public static final Spawner<Minecart> MINECART_CHEST = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "CHEST_MINECART" : "MINECART_CHEST"));
	public static final Spawner<Minecart> MINECART_COMMAND = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "COMMAND_BLOCK_MINECART" : "MINECART_COMMAND"));
	public static final Spawner<Minecart> MINECART_FURNACE = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "FURNACE_MINECART" : "MINECART_FURNACE"));
	public static final Spawner<Minecart> MINECART_HOPPER = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "HOPPER_MINECART" : "MINECART_HOPPER"));
	public static final Spawner<Minecart> MINECART_MOB_SPAWNER = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "SPAWNER_MINECART" : "MINECART_MOB_SPAWNER"));
	public static final Spawner<Minecart> MINECART_TNT = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "TNT_MINECART" : "MINECART_TNT"));
	public static final Spawner<Mule> MULE = new Spawner<>(EntityType.MULE);
	public static final Spawner<MushroomCow> MUSHROOM_COW = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "MOOSHROOM" : "MUSHROOM_COW"));
	...
	public static final Spawner<TNTPrimed> PRIMED_TNT = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "TNT" : "PRIMED_TNT"));
	...
	public static final Spawner<Snowman> SNOWMAN = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "SNOW_GOLEM" : "SNOWMAN"));
	...
	public static final Spawner<ThrownExpBottle> THROWN_EXP_BOTTLE = new Spawner<>(EntityType.valueOf(LegacyCheckService.VERSION.contains("1_21_R1") ? "EXPERIENCE_BOTTLE" : "THROWN_EXPERIENCE_BOTTLE"));
