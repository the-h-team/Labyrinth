...
public class AnvilDocket implements Docket<UnknownGeneric>, UniqueHolder {
	...
	MemoryItem item;
	Object uniqueData;
	WideFunction<String, Object, String> uniqueDataConverter;
	Menu menu;
	...
	@Override
	public <V> AnvilDocket setUniqueDataConverter(@NotNull V data, @NotNull WideFunction<String, V, String> function) {
	...
	public @NotNull AnvilDocket load() {
		...
		if (uniqueData != null) {
			this.title = uniqueDataConverter.accept(this.title, uniqueData);
		}
